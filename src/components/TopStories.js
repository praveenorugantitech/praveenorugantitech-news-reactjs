            ...
            { loading ?
                ...
                <>
                    <div className={classes.buttons}>
                        ...
                        <Button onClick={() => { getTopArticles('politics'); }} variant="outlined" style={{color:'brown'}}>Politics</Button>
                        <Button onClick={() => { getTopArticles('technology'); }} variant="outlined" color="secondary">Technology</Button>
                        <Button onClick={() => { getTopArticles('movies'); }} variant="outlined" style={{color:'green'}}>Movies</Button>
                        <Button onClick={() => { getTopArticles('food'); }} variant="outlined" style={{color:'orange'}}>Food</Button>
                    </div>
